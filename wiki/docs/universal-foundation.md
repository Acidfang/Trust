...
1. **Act** (attempt something)
2. **Experience consequence** (real, not managed)
3. **Reflect** (understand what happened)
4. **Adapt** (change based on learning)
5. **Repeat** (do again with integration)
