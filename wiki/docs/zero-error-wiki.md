...
**If any step is incomplete → GO BACK. Don't skip.**
...
- INCOMPLETE → Design not finished
- UNVERIFIED → Logic not checked
- UNKNOWN → We don't know this yet
- ASSUMPTION → We're guessing, verify this
...
- ❌ Don't code incomplete logic
- ❌ Don't assume you understood
- ❌ Don't test later, verify during thinking
...
- ✅ Complete thinking documentation
- ✅ Perfect framework compliance

**Organization Level**:
- ✅ Code quality increases
- ✅ Development speed increases
- ✅ Bug rate decreases to near zero
- ✅ Team learns framework discipline
...
Skipping any:
- ❌ Thinking phase → Bugs in code
- ❌ Verification phase → Undetected logic errors
- ❌ Pre-action checklist → Assumptions not verified
- ❌ Automation tools → Hidden duplicates and gaps
