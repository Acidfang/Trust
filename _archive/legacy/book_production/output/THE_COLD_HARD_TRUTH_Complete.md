...
# TIER 0 â€” FORMATION (COMPATIBILITY)
...
### STATE T0.1 â€” EXISTENCE (PRESENCE)
...
### STATE T0.2 â€” DIFFERENCE (USABLE GRADIENT)
...
### STATE T0.3 â€” INTERACTION (EXCHANGE)
...
### STATE T0.4 â€” RECOGNITION (ACCURATE UNDERSTANDING)
...
### STATE T0.5 â€” SELECTION (MUTUAL CONTINUATION)
...
### STATE T0.6 â€” INITIAL ALIGNMENT (FIRST RESOLUTION)
...
### STATE T1.1 â€” IDENTIFY REAL CONFLICT (NOT SURFACE)
...
### STATE T1.3 â€” RESOLVE AT SOURCE
...
# TIER 2 â€” MAINTENANCE (STABILITY)
...
### STATE T2.1 â€” CONSISTENCY OF CORRECT PATTERNS
...
### STATE T2.2 â€” REINFORCEMENT OF ALIGNMENT
...
### STATE T2.3 â€” PREVENTION OF DRIFT
...
This section provides a complete map of all states, choices, and consequences.

## System Rules Overview

**Entry Resolution**

An entry marker is resolved only when the state that produced it is revisited and the B path is completed without contradiction. Moving to a new state does not clear an entry marker. Only explicit res...

**Multi-Entry Priority**

When multiple entry markers are active, resolve the earliest-origin marker first. This prevents surface fixes that leave deeper sources running. A newer problem that blocks resolution of an older one ...

**Loop Escape**

If a state is revisited more than once with the same entry marker still unresolved, the system is in a locked loop. Stop. Escalate to the originating state of that marker. The loop will not break from...

**Hard Gate**

No unresolved entry markers are permitted at prerequisite completion. The prerequisite sheet does not accept "noted but unresolved." Every active entry marker must be resolved before the next tier ope...

**Full Reset**

When a full reset is triggered (T-1.9.A), all active entry markers persist and no prior resolution is counted as valid. The reader returns to the starting state of the tier carrying everything. Nothin...

**Path Validation**

The path written on any prerequisite sheet must be traceable through the valid transitions in this book. If the path written does not match the available routing options, the sheet is not complete. Th...
...
## Entry Markers Across All Tiers

- **accumulated drift** — appears in Tier(s): 2
- **accumulated weight** — appears in Tier(s): 1
- **alignment avoided, consistency recheck needed** — appears in Tier(s): -1
- **alignment gap unresolved** — appears in Tier(s): -1
- **assumed resolution** — appears in Tier(s): 2
- **avoidance from the start** — appears in Tier(s): -1
- **avoidance of assessment** — appears in Tier(s): 3
- **avoidance under pressure** — appears in Tier(s): -1
- **avoided difference, Tier 0 formation incomplete** — appears in Tier(s): 0, 1
- **avoided resolution, first resolution incomplete** — appears in Tier(s): 0, 1
- **avoided synchronization** — appears in Tier(s): 3
- **comfort selection** — appears in Tier(s): 0
- **comfort-based selection** — appears in Tier(s): 0
- **consistency not examined** — appears in Tier(s): -1
- **corrected** — appears in Tier(s): -1
- **default continuation, Tier 0 formation incomplete** — appears in Tier(s): 0, 1
- **deferred adaptation** — appears in Tier(s): 3
- **deferred alignment** — appears in Tier(s): 2
- **deferred check** — appears in Tier(s): 1
- **deferred presence** — appears in Tier(s): 0
- **deferred recognition, Tier 0 formation incomplete** — appears in Tier(s): 0, 1
- **deferred refinement** — appears in Tier(s): 3
- **deferred resolution** — appears in Tier(s): 1
- **distorted exchange** — appears in Tier(s): 0
- **expanded gap** — appears in Tier(s): 2
- **expansion avoided** — appears in Tier(s): 3
- **expansion without confirmed foundation** — appears in Tier(s): 3
- **failed persistence** — appears in Tier(s): 2
- **full history unresolved** — appears in Tier(s): -1
- **incomplete exchange** — appears in Tier(s): 0
- **inconsistent base, alignment check unreliable** — appears in Tier(s): -1
- **integrity avoided, persistence recheck needed** — appears in Tier(s): -1
- **integrity failure** — appears in Tier(s): -1
- **managed tension, first resolution incomplete** — appears in Tier(s): 0, 1
- **monitored but unaddressed** — appears in Tier(s): 2
- **no behavioral change** — appears in Tier(s): 1
- **partial causality** — appears in Tier(s): 1
- **partial correction** — appears in Tier(s): 2
- **pattern already running** — appears in Tier(s): -1
- **pattern uncorrected** — appears in Tier(s): -1
- **pattern uncorrected, source not traced** — appears in Tier(s): -1
- **persistence avoided** — appears in Tier(s): -1
- **reaction-driven, distinction not made** — appears in Tier(s): -1
- **real exchange** — appears in Tier(s): 0
- **real selection** — appears in Tier(s): 0
- **regulation not built, persistence compromised** — appears in Tier(s): -1
- **repeated avoidance** — appears in Tier(s): -1
- **stopping accepted as permanent** — appears in Tier(s): -1
- **suppressed before regulation was built** — appears in Tier(s): -1
- **tested picture** — appears in Tier(s): 0
- **unadapted under pressure** — appears in Tier(s): 3
- **unassessed weakness** — appears in Tier(s): 3
- **unconfirmed resolution** — appears in Tier(s): 1
- **unexamined conflict** — appears in Tier(s): 1
- **unexamined consistency** — appears in Tier(s): 2
- **unexamined constraints** — appears in Tier(s): 3
- **unexamined divergence** — appears in Tier(s): 3
- **unexamined integration load** — appears in Tier(s): 3
- **unjustified** — appears in Tier(s): -1
- **unnoticed drift** — appears in Tier(s): 2
- **untested picture** — appears in Tier(s): 0
- **wrong source resolved** — appears in Tier(s): 1
...
- **For self work:** Start at Tier -1, State T-1.1
- **For connection issues:** Start at Tier 0, State T0.1
- **For relationship conflict:** Start at Tier 1, State T1.1
- **For maintaining what you built:** Start at Tier 2, State T2.1
- **For growth and expansion:** Start at Tier 3, State T3.1

## Understanding the System

- Entry markers persist through tiers until resolved at their source
- Choices A, B, C have consistent meaning across all states
- Prerequisite sheets must be completed before advancing to next tier
- All choices are traceable through valid transitions
