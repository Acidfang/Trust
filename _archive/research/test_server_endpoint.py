...
def handle_query():
    ...
    try:
        ...
        # Apply guardian
        print(f"[DEBUG] Before guard_response call")
        print(f"  candidate_response type: {type(candidate_response)}")
        print(f"  query type: {type(query)}")
        print(f"  session_id: {ledger.current_session_id}")
        print(f"  guardian_history len: {len(guardian_history)}")
        ...
        print(f"[DEBUG] After guard_response call")
        print(f"  guardian_action: {guardian_action}")
        print(f"  guardian_reason: {guardian_reason}")
        ...
        print(f"[DEBUG] Before core_systems.process_response")
        ...
        print(f"[DEBUG] After core_systems.process_response")
