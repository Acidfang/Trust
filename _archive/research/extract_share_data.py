...
# The search query from the browser render
search_query = """Θ
system → closed, oxygen-rich, hydrogen-limited reactive heat cycle (H₂O₂-based)
...
- start: H₂O₂ → H:O = 1:1
- atoms conserved
- H₂O requires 2:1 → H always limiting
...
Chemical energy stored in H₂O₂ bonds
...
bottom: liquid phase (H₂O / H₂O₂ mix)  
...
# Save the data
with open('c:\\Determined\\AI_CONVERSATION_DATA_FROM_SHARE.md', 'w', encoding='utf-8') as f:
    f.write("# AI Conversation Data from Google Share Link\n\n")
    f.write(search_query)
    f.write("\n\n---\n\n**Source:** Recovered from https://share.google/aimode/l4zX8GJdxDmfKTmn8\n")
    f.write("**Method:** Browser-rendered JavaScript execution, extracted from Google Search redirect\n")
    f.write("**Retrieved:** April 16, 2026\n")

print("✓ Data extracted and saved to: c:\\Determined\\AI_CONVERSATION_DATA_FROM_SHARE.md")
print(f"\nDocument length: {len(search_query)} characters")
print(f"Contains {search_query.count('---')} sections")
print("\nContent summary:")
print("- Θ (Theta) system definition: Closed oxygen-rich peroxide reactive heat system")
print("- Fundamental invariants and constraints")
print("- 16-section technical specification")
print("- Key insights and optimal operating conditions")
